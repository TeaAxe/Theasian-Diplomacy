...
ALTER TABLE SkillDB 
  ADD CONSTRAINT CP_SkillDB_Cle_primaire PRIMARY KEY (
    SkillDBID)  ;
ALTER TABLE ArmyDB
  ADD CONSTRAINT CE_arCharacterDBID 
...
ALTER TABLE ArmyDB
  ADD CONSTRAINT CE_arFactionDBID 
    FOREIGN KEY (aFactionDBID)
      REFERENCES FactionDB;

ALTER TABLE ArmyDB
  ADD CONSTRAINT CE_arLocationDBID 
...
ALTER TABLE CityDB
  ADD CONSTRAINT CE_ciFactionDBID 
...
ALTER TABLE CityDB
  ADD CONSTRAINT CE_ciLocationDBID 
